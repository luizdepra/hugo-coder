...
See [here](https://seth-ossidian.gitlab.io/).

## Quick Start

1. Add the repository into your Hugo Project repository as a submodule, `git submodule add https://github.com/seth-ossidian/hugo-coder-gruvbox.git themes/hugo-coder-gruvbox`.
...
Coder is licensed under the [MIT license](https://github.com/seth-ossidian/hugo-coder-gruvbox/blob/main/LICENSE.md).